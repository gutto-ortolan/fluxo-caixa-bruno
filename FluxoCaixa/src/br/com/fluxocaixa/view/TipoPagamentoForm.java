...
import br.com.fluxocaixa.view.adicionar.NovoTipoPagamentoForm;
...
public class TipoPagamentoForm extends javax.swing.JInternalFrame {

    private DefaultTableModel tabelaModelo;
    private Integer sizeTab = 1145;

    private static TipoPagamentoForm testeframe;
    
    private TipoPagamentoDAO tipoPagamentoDAO = new TipoPagamentoDAO();

    public static TipoPagamentoForm getInstancia() {
        testeframe = new TipoPagamentoForm();
        return testeframe;
    }
    ...
    public TipoPagamentoForm() {
        initComponents();
        setResizable(false);
        tabela.setModel((new DefaultTableModel(null, new Object[]{"Código", "Descrição"})));
        tamanho_colunas();
        readJTable();
    }
    ...
    public void readJTable() {
        ...
        for (TipoPagamento TipoPagamento : tipoPagamentoDAO.buscar()) {
    ...
    private void bntNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntNovoActionPerformed
        NovoTipoPagamentoForm janelaNovo = new NovoTipoPagamentoForm("I");
        janelaNovo.setTitle("Tipo Pagamento");
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
       if (tabela.getSelectedRow() != -1) {
            TipoPagamento obj = tipoPagamentoDAO.buscarId(Integer.parseInt(tabela.getValueAt(tabela.getSelectedRow(), 0).toString()));

            NovoTipoPagamentoForm janela = new NovoTipoPagamentoForm("A");
            janela.setTitle("Tipo Lançamento");
            janela.setModal(true);
            janela.setLocationRelativeTo(null);
            janela.alterarTipoPagamento(obj);
    ...
    private void tamanho_colunas() {
        ...
        modeloDaColuna.getColumn(1).setMaxWidth((sizeTab * 90) / 100);
