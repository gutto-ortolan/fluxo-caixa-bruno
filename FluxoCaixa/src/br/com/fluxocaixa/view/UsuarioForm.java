...
import br.com.fluxocaixa.view.adicionar.NovoUsuarioForm;
...
public class UsuarioForm extends javax.swing.JInternalFrame {
    ...
    private static UsuarioForm testeframe;
    
    private UsuarioDAO usuarioDAO = new UsuarioDAO();

    public static UsuarioForm getInstancia() {
        testeframe = new UsuarioForm();
        return testeframe;
    }
    ...
    public UsuarioForm() {
        initComponents();
        setResizable(false);
        tabela.setModel((new DefaultTableModel(null, new Object[]{"Código", "Nome", "Login", "Senha"})));
        tamanho_colunas();
        readJTable();
    }
    ...
    public void readJTable() {
        ...
        for (Usuario usuario : usuarioDAO.buscar()) {
    ...
    private void bntNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntNovoActionPerformed
        NovoUsuarioForm janelaNovo = new NovoUsuarioForm("I") {};
        janelaNovo.setTitle("Usuário");
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        if (tabela.getSelectedRow() != -1) {
            Usuario obj = usuarioDAO.buscarId(Integer.parseInt(tabela.getValueAt(tabela.getSelectedRow(), 0).toString()));

            NovoUsuarioForm janela = new NovoUsuarioForm("A");
            janela.setTitle("Usuário");
            janela.setModal(true);
            janela.setLocationRelativeTo(null);
            janela.alterarUsuario(obj);
    ...
    private void tamanho_colunas() {
        ...
        modeloDaColuna.getColumn(2).setMaxWidth((sizeTab * 30) / 100);
        modeloDaColuna.getColumn(3).setMaxWidth((sizeTab * 30) / 100);
